...
keyboard.inline_keyboard = {
{
{text = '᥀ Source Channel', url="t.me/revorb0t"},
},
{
{text = '᥀ Developer', url="t.me/uu_iv"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/https://t.me/BLACK_TEAM_4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
if text == 'اطردني' or text == 'احظرني' and GetChannelMember(msg) then   
...
Text = ' 𖢅ٖ  تم تفعيل امر اطردني'
bot_data:del(ban_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' 𖢅ٖ  بالتاكيد تم تفعيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖢅ٖ  تم تعطيل امر اطردني'
else
Text = '\n 𖢅ٖ  بالتاكيد تم تعطيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖢅ٖ  الصوره معطله") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," 𖢅ٖ  عدد صورك ➢ "..result.total_count_.." صوره‌‏", msg.id_, msg.id_, "md")
else
